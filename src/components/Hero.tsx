        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Soluzioni professionali per <span className="text-accent">demolizioni</span> e <span className="text-accent">recupero materiali</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/servizi" className="btn px-8 py-3 text-lg border border-accent/20 hover:bg-accent/5 transition-colors">
                Scopri i servizi
              </Link>
            </div>
