    ...
    <section className="py-20 border-t border-white/10">
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          >
            Desmare offre servizi professionali con l'obiettivo di unire efficienza, sicurezza e sostenibilità ambientale in ogni progetto.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="mb-6 w-12 h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center mx-auto">
